...
<v-card :elevation="hover ? 16 : 2"
     ...
     <router-link :to="`/movie/${movie.id}`">
          <v-img :src="posterPath" alt="" class=""/>
            ...
            <v-col cols="12" sm="8">
                ...
                <v-row>
                    ...
                    <v-col cols="12" sm="7">
                        <div class="subtitle-2 dark--text ml-n16">
                ...
                <p class="mt-5 dark--text text--darken-3 subheader">{{this.movie.overview}}</p>
                <div class="mt-5">
                    <h2 class="mt-5 dark--text text--darken-3">Featured FilmCast</h2>
                ...
                >
                    <template v-slot:activator="{on, attrs}">
                        <v-btn tile color="red ml-2 white--text" v-bind="attrs" v-on="on" @click.prevent="openYouTubeModel">
                    ...
                    <v-card>
                        ...
                        <v-card-actions>
                            <v-spacer></v-spacer>
                            <v-btn color="red" class="ml-2 dark--text" text @click="dialog = flase">Close</v-btn>
                        </v-card-actions>
                    </v-card>
                </v-dialog>
                <v-btn tile color="red" class="ml-2 white--text">
                    <button  @click="liked()"> 
        ...
        <v-divider class="mt-2"></v-divider>
         <FilmCast :FilmCasts="movie.credits.FilmCast"/>
         <v-divider class="mt-2"></v-divider>
...
<script>
import FilmCast from "./FilmCast.vue"
...
Images,
  ...
  methods: {
    ...
    liked() {
      this.$store.commit("ADD_FAV_MOVIE", { 
        movie: this.movie
        ...
        //movie i obje kullanarak göndermeye çalıştım ancak bir 
        //türlü favs sekmesinde gösteremedim. eğer öğrenirsem dosyayı güncelleyeceğim.
        //şimdilik favori sssekmesinde filmin sadece ismini gösterebilmekteyim. saygılar.
  },
